...
<table class="table table-hover table-striped">
    <thead>
        <th>NO</th><th>Tanggal Pinjam</th><th>Tanggal harus Kembali</th><th>Nama Buku</th><th>Status</th><th>Aksi</th><th>Hapus</th>
    </thead>
    <tbody>
        <?php 
        include "koneksi.php";
        ...
        while($dt_histori=mysqli_fetch_array($qry_histori)){
            ...
            $button_hapus="<a href='hapus_history.php?id_peminjaman_buku=".$dt_histori['id_peminjaman_buku']."' class='btn btn-danger' onclick='return confirm(\"Apakah anda yakin menghapus data ini?\")'>Hapus</a>";
        ?>
            <tr>
                <td><?=$no?></td>
